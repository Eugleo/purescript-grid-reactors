...
(function($PS) {
  ...
  var index = function (v) {
      var $85 = Data_Array.index(v.value0);
      var $86 = to1D(v.value1.width);
      return function ($87) {
          return $85($86($87));
      };
  };
  ...
  var differencesFrom = function (dictEq) {
      return function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Data.Grid (line 100, column 1 - line 105, column 33): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  exports["Grid"] = Grid;
                  ...
                  var renderCell = function (context) {
                      return function (size) {
                          return function (v) {
                              ...
                              throw new Error("Failed pattern match at Reactor.Page (line 232, column 5 - line 248, column 14): " + [ v.value1.constructor.name ]);
                          };
                      };
                  };
                      ...
                      return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.get(propsId))(function (v1) {
                          return Reactor_Internal_Helpers.withJust(Halogen_Hooks_HookM.applicativeHookM)(v.context)(function (ctx) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Hooks_HookM.bindHookM)((function () {
                                  ...
                                  throw new Error("Failed pattern match at Reactor.Page (line 225, column 7 - line 228, column 76): " + [ v.lastGrid.constructor.name ]);
                              })())(function () {
                      ...
                      return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState({
                          ...
                          return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState({
                              ...
                              return Halogen_Hooks_Hook.discard(Halogen_Hooks.useLifecycleEffect(Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Graphics_CanvasAction.getCanvasElementById(Halogen_Hooks_HookM.monadEffectHookM(dictMonadEffect))(canvasId))(function (v6) {
                                  ...
                                  throw new Error("Failed pattern match at Reactor.Page (line 66, column 50 - line 81, column 23): " + [ v6.constructor.name ]);
                              })))(function () {
...
(function($PS) {
  ...
  var draw = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Reactor_Graphics_Drawing.bindDrawingM)(Reactor_Graphics_Drawing.drawGrid(v.cells)(function (cell) {
          ...
          if (cell instanceof Alive) {
              return Data_Maybe.Just.create(Reactor_Graphics_Colors.hsl(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingNumber)(Data_Int.toNumber(cell.value0))(360.0))(0.6)(0.75));
          };
          throw new Error("Failed pattern match at Example.Gol.Main (line 43, column 5 - line 45, column 74): " + [ cell.constructor.name ]);
      }))(function () {
  ...
  var advanceWorld = function (dictMonadEffect) {
      var neigbourCount = function (cells) {
          return function (v) {
              return Data_Array.length(Data_Array.filter(function (c) {
                  return Data_Eq.notEq(Data_Maybe.eqMaybe(eqCell))(c)(new Data_Maybe.Just(Dead.value));
              })(Data_Functor.map(Data_Functor.functorArray)(Data_Grid.index(cells))([ {
                  x: v.x + 1 | 0,
                  y: v.y
              }, {
                  x: v.x - 1 | 0,
      ...
      var modifyCell = function (cells) {
          return function (position) {
              return function (cell) {
                  var ns = neigbourCount(cells)(position);
                  if (cell instanceof Dead) {
                      var $26 = ns === 3;
                      if ($26) {
                          return new Alive(0);
                  ...
                  throw new Error("Failed pattern match at Example.Gol.Main (line 79, column 7 - line 81, column 74): " + [ cell.constructor.name ]);
              };
          };
      };
